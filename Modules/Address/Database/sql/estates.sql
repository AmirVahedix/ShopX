...
INSERT INTO `estates` (`id`, `zone_id`, `name`) VALUES
(1, 1, 'تبريز'),
(2, 1, 'كندوان'),
(3, 1, 'بندر شرفخانه'),
(4, 1, 'مراغه'),
...
ALTER TABLE `estates`
  ADD PRIMARY KEY (`id`),
  ADD KEY `estates_zone_id_foreign` (`zone_id`);
...
--
ALTER TABLE `estates`
  ADD CONSTRAINT `estates_zone_id_foreign` FOREIGN KEY (`zone_id`) REFERENCES `zones` (`id`) ON DELETE CASCADE;
